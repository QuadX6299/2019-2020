...
class NPathBuilder constructor(val spacing : Double = 2.0, val a : Double = .9, val b : Double = .1, val tol : Double = .5, val mc : MotionConstraint = MotionConstraint(30.0, 7.0, 1.0)) {
